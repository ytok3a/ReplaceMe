...
let item0: Item = Item(name: "", icon: "None")
...
let presets = [item0, item1, item2, item3, item4, item5]


// TODO: "None",


// TODO: add after can use .years
...
//let item6: Item = Item(name: "Air Filter", icon: "🏠", lastReplaced: Date(), replaceEvery: DateDuration(value: 1, unit: .years), remindBefore: DateDuration(value: 1, unit: .weeks), notes: "")
//let item6: Item = Item(name: "Smoke Alarm Batteries"", icon: "🔋", lastReplaced: Date(), replaceEvery: DateDuration(value: 1, unit: .years), remindBefore: DateDuration(value: 1, unit: .weeks), notes: "")
